...
class OpenNFRWizardSetup(ConfigListScreen, Screen):
    ...
    def reloadPlugin(self):
              if fileExists("/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/PluginReLoad.py") or fileExists("/usr/lib/enigma2/python/Plugins/Extensions/Infopanel/PluginReLoad.pyo"):    
